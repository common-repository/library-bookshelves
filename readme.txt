...
Tags: books, bookshelf, library, catalog, OPAC
...
= 5.7 =
* Added option to disable automatic Capitalization of item title and author metadata retrieved from web services.
